...
def main(zero, ads_id, seed, password):
    try:
        ...
        chrome_driver = "C:\Python\chromedriver-windows-x64.exe"
...
with open("c:\Python\dolphin-import-metamask-WIN\id_users.txt", "r") as f:
    id_users = [row.strip() for row in f]

with open("C:\Python\dolphin-import-metamask-WIN\seeds.txt", "r") as f:
